...
public class HomeController {
	...
	@Autowired
	TimeDepositAccountsRepository timeDepositAccountsRepository;

	@RequestMapping(value="/accountsList", method = RequestMethod.GET)
	public ResponseEntity<Object> getAccountsList() {
		List<TimeDepositAccount> accountsList = (List<TimeDepositAccount>)timeDepositAccountsRepository.findAll();
